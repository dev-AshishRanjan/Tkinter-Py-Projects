...
button_clear=Button(root, text='CLEAR',padx=73, pady=20, command=button_clear,bg='white', fg='red')
button_add=Button(root, text='+',padx=39, pady=20, command=button_add, bg='white', fg='red')
button_equal=Button(root, text='=',padx=86.49, pady=20, command=button_equal, bg='white', fg='red')
